...
| Part 4 managed-execution readiness | `LOCAL_VERIFIED` | Current-source prerequisite binding, bounded OIDC lifetime, workflow shell parsing, destroy-plan binary recheck, structured failure evidence, and pre-authority lease recovery; no Stage 6 AWS run yet |
